...
class ProductJdbcRepositoryTest {
    ...
    static void setup() {
        var config = aMysqldConfig(Version.v8_0_11)
                ...
                .withPort(2215)
                .withUser("admin", "admin1234")
                .withTimeZone("Asia/Seoul")
                .build();
        embeddedMysql = anEmbeddedMysql(config)
                .addSchema("test_order_mgmt", ScriptResolver.classPathScript("schema.sql"))
                .start();
    }
    ...
    void testUpdate() {
        ...
        assertThat(product.get().getProductId(), is(newProduct.getProductId()));
    }
